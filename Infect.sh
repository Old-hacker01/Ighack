# A tool by nitro from www.45Tech.com
...
echo -e "$red                      ⫸$ylo  45Tech$red ⫷$rset"
echo 
# Functions
...
echo " " 
echo -e "$red                       ▶Coded by$grn NITRO$red◀$rset"
echo -e "$red                      ⫸$ylo  45Techs$red ⫷$rset"
echo 
# Functions
echo -e "$red                    [Infect them with fun]$rset"
echo " "
...
echo -e "\e[93m        MY WEBSITE:\e[92m www.45Tech.com\e[0m" | pv -qL 10
...
while git clone https://github.com/Old-hacker01/infect 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
